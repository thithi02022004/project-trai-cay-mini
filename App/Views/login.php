                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="signin-container">
                            <form action="<?=BASE_PATH?>login" name="frm-login" method="post">
                                <p class="form-row">
                                    <label for="fid-phone">Nhập số điện thoại:<span class="requite">*</span></label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="register-in-container">
                            <div class="intro">
                                ...
                                <a href="<?=BASE_PATH?>show_register" class="btn btn-bold">Create an account</a>
                            </div>
                        </div>
                    </div>
