                ...
                <!-- summary info -->
                    <div class="sumary-product single-layout">
                        <div class="media">
                            ...
                            <?php foreach ($img_detail as $key => $img) :?>
                                <li><img src="public/frontend/assets/images/products/<?=$img['image']?>" alt="" width="500" height="500"></li>
                                <?php endforeach ?>
                            </ul>
                            <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                            <?php foreach ($img_detail as $key => $img) :?>
                                <li><img src="public/frontend/assets/images/products/<?=$img['image']?>" alt="" width="88" height="88"></li>
                                <?php endforeach ?>
                            </ul>
                        </div>
                    <div class="product-attribute">
                        ...
                        <div class="rating">
                            ...
                            <!-- <b class="category"> Danh Mục: </b> -->
                        </div>
                        <span class="sku"><?=$detail['cateName']?></span>
                        <p class="excerpt"><?=$detail['material']?></p>
                        <div class="price">
                            <ins><span class="price-amount"><span class="currencySymbol">£</span><?=number_format($detail['price'])?></span></ins>
                        </div>
                    ...
                    <form action="<?=BASE_PATH?>add_cart&id=<?=$detail['id']?>" method="POST">
                        <div class="action-form">
                            ...
                            <div class="buttons">
                                <!-- <a href="<?=BASE_PATH?>add_cart&id=<?=$detail['id']?>" class="btn add-to-cart-btn">Thêm vào giỏ hàng</a> -->
                            ...
                            <div class="acepted-payment-methods">
                                <ul class="payment-methods">
                                    <li><img src="public/frontend/assets/images/card1.jpg" alt="" width="51" height="36"></li>
                                    <li><img src="public/frontend/assets/images/card2.jpg" alt="" width="51" height="36"></li>
                                    <li><img src="public/frontend/assets/images/card3.jpg" alt="" width="51" height="36"></li>
                                    <li><img src="public/frontend/assets/images/card4.jpg" alt="" width="51" height="36"></li>
                                </ul>
                            </div>
                        </div>
                    </form>
                ...
                <div class="product-tabs single-layout biolife-tab-contain">
                    ...
                    <div class="tab-content">
                        <div id="tab_1st" class="tab-contain desc-tab active">
                            <p class="desc">Quisque quis ipsum venenatis, fermentum ante volutpat, ornare enim. Phasellus molestie risus non aliquet cursus. Integer vestibulum mi lorem, id hendrerit ante lobortis non. Nunc ante ante, lobortis non pretium non, vulputate
                                vel nisi. Maecenas dolor elit, fringilla nec turpis ac, auctor vulputate nulla. Phasellus sed laoreet velit. Proin fringilla urna vel mattis euismod. Etiam sodales, massa non tincidunt iaculis, mauris libero scelerisque
                                justo, ut rutrum lectus urna sit amet quam. Nulla maximus vestibulum mi vitae accumsan. Donec sit amet ligula et enim semper viverra a in arcu. Vestibulum enim ligula, varius sed enim vitae, posuere molestie velit. Morbi
                                risus orci, congue in nulla at, sodales fermentum magna.</p>
                            ...
                            <div class="accodition-tab biolife-accodition">
                                <ul class="tabs">
                                    <li class="tab-item">
                                        ...
                                        <div class="content">
                                            <p>Orders placed before 3pm eastern time will normally be processed and shipped by the following business day. For orders received after 3pm, they will generally be processed and shipped on the second business
                                                day. For example if you place your order after 3pm on Monday the order will ship on Wednesday. Business days do not include Saturday and Sunday and all Holidays. Please allow additional processing time if
                                                you order is placed on a weekend or holiday. Once an order is processed, speed of delivery will be determined as follows based on the shipping mode selected:</p>
                                            <div class="desc-expand">
                                    ...
                                    <li class="tab-item">
                                        ...
                                        <div class="content">
                                            <p>You will pay a shipping rate based on the weight and size of the order. Large or heavy items may include an oversized handling fee. Total shipping fees are shown in your shopping cart. Please refer to the following
                                                shipping table:</p>
                                    ...
                                    <li class="tab-item">
                                        ...
                                        <div class="content">
                                            <p>We do not deliver to P.O. boxes or military (APO, FPO, PSC) boxes. We deliver to all 50 states plus Puerto Rico. Certain items may be excluded for delivery to Puerto Rico. This will be indicated on the product
                                                page.
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="tab-item">
                                        ...
                                        <div class="content">
                                            <p>Occasionally packages are returned to us as undeliverable by the carrier. When the carrier returns an undeliverable package to us, we will cancel the order and refund the purchase price less the shipping charges.
                                                Here are a few reasons packages may be returned to us as undeliverable:</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <div class="comment-container">
                                                <div class="row">
                                                    <div class="comment-content col-lg-8 col-md-9 col-sm-8 col-xs-12">
                                                        ...
                                                        <p class="comment-text">There are few things in life that please people more than the succulence of quality fresh fruit and vegetables. At Fresh Fruits we work to deliver the world’s freshest, choicest, and juiciest produce
                                                            to discerning customers across the UAE and GCC.</p>
                                                    </div>
                                ...
                                <div class="info">
                                    ...
                                    <div class="slide-down-box">
                                        ...
                                        <div class="buttons">
                                            ...
                                            <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ</a>
