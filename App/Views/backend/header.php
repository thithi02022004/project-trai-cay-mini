...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="public/backend/assets/css/app.min.css">
    <!-- Template CSS -->
    <link rel="stylesheet" href="public/backend/assets/css/style.css">
    <link rel="stylesheet" href="public/backend/assets/css/components.css">
    <!-- Custom style CSS -->
    <link rel="stylesheet" href="public/backend/assets/css/custom.css">
    <link rel='shortcut icon' type='image/x-icon' href='public/backend/assets/img/favicon.ico' />
</head>
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
              ...
              <span class="badge headerBadge1">
                6 </span> </a>
                        <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="public/backend/assets/img/users/user-1.png" class="rounded-circle">
                    ...
                    <img alt="image" src="public/backend/assets/img/users/user-2.png" class="rounded-circle">
                      ...
                      application</span>
                                ...
                                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="public/backend/assets/img/users/user-5.png" class="rounded-circle">
                      ...
                      generated.</span> <span class="time">12 Min Ago</span>
                                ...
                                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="public/backend/assets/img/users/user-4.png" class="rounded-circle">
                      ...
                      Min Ago</span>
                                ...
                                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="public/backend/assets/img/users/user-3.png" class="rounded-circle">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="public/backend/assets/img/user.png" class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
