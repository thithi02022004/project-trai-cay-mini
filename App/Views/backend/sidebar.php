<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="public/backend/assets/img/logo.png" class="header-logo" /> <span class="logo-name">Otika</span>
            </a>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Menu</li>
            <li class="dropdown active">
                <a href="index.html" class="nav-link"><i data-feather="monitor"></i><span>Màn hình chính</span></a>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Danh mục</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_category">Quản lý danh mục</a></li>
                    <!-- <li><a class="nav-link" href="#">Thêm chức năng </a></li> -->
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Đơn hàng</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_order">Quản lý đơn hàng</a></li>
                </ul>
            </li>
            <li class="dropdown">
