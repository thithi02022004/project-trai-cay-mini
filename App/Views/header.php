...
?>
<?php
    $total = 0; // Khởi tạo biến total với giá trị ban đầu là 0
    if (isset($_SESSION['cart'])) {
        foreach ($_SESSION['cart'] as $key => $item) {
            $total += $item['price'] * $item['qty']; // Cộng dồn giá trị price vào biến total
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="public/frontend/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="public/frontend/assets/css/nice-select.css">
    <link rel="stylesheet" href="public/frontend/assets/css/slick.min.css">
    <link rel="stylesheet" href="public/frontend/assets/css/style.css">
    <link rel="stylesheet" href="public/frontend/assets/css/main-color01.css">
</head>
            ...
            <div class="container">
                ...
                <div class="top-bar right">
                    <ul class="horizontal-menu">
                        ...
                        <?php else : ?>
                            <li><a href="<?=BASE_PATH?>show_login" class="login-link"><i class="biolife-icon icon-login"></i>Đăng nhập</a></li>
                        <?php endif ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="home-01.html" class="biolife-logo"><img src="public/frontend/assets/images/logo-biolife-1.png" alt="biolife logo" width="135" height="36"></a>
                    </div>
                    <div class="col-lg-9 col-md-10 padding-top-2px">
                        ...
                        <div class="live-info">
                            <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number"><?=$cf['hotline']?></b></p>
                            <p class="working-time"><?=$cf['content']?></p>
                        </div>
                    </div>
                                ...
                                <ul class="menu clone-main-menu">
                                    <?php foreach ($category as $key => $cate) : ?>
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fruit & Nut Gifts"><i class="biolife-icon icon-fruits"></i><?=$cate['name']?></a>
                                                                ...
                                                                <ul class="products-list default-product-style biolife-carousel nav-none-after-1k2 nav-center" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":1, "responsive":[{"breakpoint":767, "settings":{ "arrows": false}}]}'>
                                                                    ...
                                                                    <li class="product-item">
                                                                        <div class="contain-product none-overlay">
                                                                            <div class="product-thumb">
                                                                                <a href="#" class="link-to-product">
                                                                                    <img src="public/frontend/assets/images/products/p-11.jpg" alt="dd" width="270" height="270" class="product-thumnail">
                                                                                </a>
                                                                            </div>
                                                                            <div class="info">
                                                                                <b class="categories">Fresh Fruit</b>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                                                            <div class="biolife-brand">
                                                                <ul class="brands">
                                                                    <li>
                                                                        <a href="#"><img src="public/frontend/assets/images/megamenu/brand-organic.png" width="161" height="136" alt="organic"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#"><img src="public/frontend/assets/images/megamenu/brand-explore.png" width="160" height="136" alt="explore"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#"><img src="public/frontend/assets/images/megamenu/brand-organic-2.png" width="99" height="136" alt="organic 2"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#"><img src="public/frontend/assets/images/megamenu/brand-eco-teas.png" width="164" height="136" alt="eco teas"></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 hidden-sm hidden-xs md-possition-initial">
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                <li class="menu-item"><a href="<?=BASE_PATH?>">Trang Chủ</a></li>
                                <li class="menu-item menu-item-has-children has-megamenu">
                                    <a href="<?=BASE_PATH?>product" class="menu-name" data-title="Shop">Shop</a>
                                ...
                                <li class="menu-item menu-item-has-children has-child">
                                    <a href="<?=BASE_PATH?>product" class="menu-name" data-title="Product">Sản phẩm</a>
                                    <!-- <ul class="sub-menu">
                                ...
                                <!-- <li class="menu-item menu-item-has-children has-megamenu">
                                    <a href="#" class="menu-name" data-title="Pages">Giảm sốc</a>
                                ...
                                <li class="menu-item menu-item-has-children has-megamenu">
                                    <a href="#" class="menu-name" data-title="Blog">Bài viết</a>
                                    <!-- <div class="wrap-megamenu lg-width-800 md-full-width">
                                        <div class="mega-content">
                                                    ...
                                                    <ul class="posts">
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb">
                                                                    <a href="#"><img src="public/frontend/assets/images/megamenu/thumb-05.jpg" width="100" height="73" alt=""></a>
                                                                </div>
                                                                <div class="left-info">
                                                        ...
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb">
                                                                    <a href="#"><img src="public/frontend/assets/images/megamenu/thumb-06.jpg" width="100" height="73" alt=""></a>
                                                                </div>
                                                                <div class="left-info">
                                                                    <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb">
                                                                    <a href="#"><img src="public/frontend/assets/images/megamenu/thumb-07.jpg" width="100" height="73" alt=""></a>
                                                                </div>
                                                                <div class="left-info">
                                                                    <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                                        ...
                                        <?php foreach ($_SESSION['cart'] as $key => $cart) : ?>   
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="public/frontend/assets/images/products/<?=$cart['img']?>" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name"><?=$cart['name']?></a></div>
                                                            <div class="price">
                                                                <ins><span class="price-amount"><span class="currencySymbol">£</span><?=$cart['price'] * $cart['qty']?></span></ins>
                                                                <!-- <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del> -->
                                                            </div>
                                                            <div class="qty">
                                                        ...
                                                        <div class="action">
                                                            ...
                                                            <a href="<?=BASE_PATH?>unset_cart">Xóa</a>
                                                        </div>
                                                    </div>
                                                </li>
                                           <?php endforeach ?>
                                            ...
                                            <p class="btn-control">
                                                <a href="<?=BASE_PATH?>view_cart" class="btn view-cart">view cart</a>
